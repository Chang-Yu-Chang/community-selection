...
p6 <- ggplot() + 
  # geom_point(t_final,mapping = aes(x=R,y=Fmean,col=Community),size= 1,shape=1) +
  geom_point(t_final,mapping = aes(x=R,y=Fmean,col=Community),size= 1,shape=1) + theme_pubr() +

...
p2 <- ggplot()  +
  ...
  scale_x_continuous(limits = c(-550,2500),breaks=c(-500,2500)) + scale_y_continuous(limits=c(-550,2500),breaks=c(500,2500))
...
p2_new = p2 + annotation_custom(ggplotGrob(ggarrange(p2b,p2a)),xmin =-550,xmax =1350,ymin=1450,ymax=2750)
p4_new = p4 + annotation_custom(ggplotGrob(ggarrange(p4b,p4a)),xmin =-550,xmax =1350,ymin=1450,ymax=2750)
left = ggarrange(p1,p2_new,p3,p4_new,labels=c('A','B','C','D'))
ggsave('../Plots/FigS5.png',width=7,height=6)
